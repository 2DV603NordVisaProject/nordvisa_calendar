    ...
    return (
      <ul>
        ...
        }
        {
          Client.isLogedIn() ? (
            <div>
              <li><Link to="/user/my-account" className="menu-link">My Account</Link></li>
              <li><Link to="/user/create-event" className="menu-link">Create Event</Link></li>
              <li><Link to="/user/my-events" className="menu-link">My Events</Link></li>
